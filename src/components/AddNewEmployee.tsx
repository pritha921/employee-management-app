...
//         <h2 className="text-lg font-semibold leading-7 text-gray-900 mb-6 text-center">Add New Employee</h2>
...
export default function AddNewEmployee() {
  ...
  const onSubmit = async (data: FormData) => {
    try {
      ...
      setApiFetch(true); // Trigger API fetch in HomePage
    } catch (error) {
      console.error('Error saving the employee data', error);
    }
  };
  ...
  const handleCancel = () => {
    setApiFetch(false); // Prevent any further API calls
  };
